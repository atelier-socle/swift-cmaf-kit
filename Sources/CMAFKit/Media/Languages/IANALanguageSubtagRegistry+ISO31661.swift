...
// MARK: - IANALanguageSubtagRegistry — ISO 3166-1 alpha-2 regions
//
// Reference: ISO 3166-1 — Codes for the representation of names of
// countries and their subdivisions (alpha-2). Snapshot 2026-05.
// ~250 active codes. Codes outside this set pass via the syntax-only
// validator.
...
extension IANALanguageSubtagRegistry {
    ...
    /// Active ISO 3166-1 alpha-2 region codes (uppercase canonical,
    /// snapshot 2026-05).
    internal static let iso3166_1Regions: Set<String> = [
